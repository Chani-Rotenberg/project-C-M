            ...
            <>
                ...
                <div className="col-12" key={course.code}>
                    <div className={classNames('flex flex-column xl:flex-row xl:align-items-start p-4 gap-4', { 'border-top-1 surface-border': index !== 0 })}>
                        {course.image ? <img alt={course.name} className="w-9 sm:w-16rem xl:w-10rem shadow-2 block xl:block mx-auto border-round" src={`http://localhost:1122/uploads/${course.image.split("\\")[2]}`}></img> : <></>}
                ...
                <div className="col-12 sm:col-6 lg:col-12 xl:col-4 p-2" key={course.code}>
                    <div className="p-4 border-1 surface-border surface-card border-round">
                        ...
                        <div className="flex flex-column align-items-center gap-3 py-5">
                            {course.image ? <img className="w-9 shadow-2 border-round" src={`http://localhost:1122/uploads/${course.image.split("\\")[2]}`} alt={course.name} /> : <></>}
